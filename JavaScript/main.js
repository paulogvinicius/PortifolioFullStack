...
// Remova aquele bloco do window.onload e altere a função begin para incluir o setTimeout:
window.addEventListener("load", function begin() {
  projetos(projectsSection);
  const desafioBtn = document.querySelector("#desafio");
  ...
  // O temporizador de 4 segundos fica aqui dentro agora, sem sumir com o notebook_1
  setTimeout(() => {
